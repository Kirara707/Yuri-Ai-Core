...
# ---------- 1. 旧数据第一次运行 ----------
old = pd.read_csv(r'train\csv\Line_count_statistics.csv',
...
# 存两套参数
joblib.dump(rob, r'train\script\normalizer\line_robust_step.pkl')
joblib.dump(mm,  r'train\script\normalizer\line_mm_step.pkl')

joblib.dump(rob, r'train\script\normalizer\line_robust_step4.pkl', protocol=4)
joblib.dump(mm,  r'train\script\normalizer\line_mm_step4.pkl',  protocol=4)